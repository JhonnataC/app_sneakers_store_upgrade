...
class BaseTenis {
  ...
  static final Image imageYeezy = Image.asset('assets/imgs/ad_yeezy_boost350_bred.png');
  static final Image imageCactus = Image.asset('assets/imgs/air_force1_cactus_jack.png');
  static final Image imageBlack = Image.asset('assets/imgs/air_force1_offwhite_black.png');
  static final Image imageVolt = Image.asset('assets/imgs/air_force1_offwhite_volt.png');
  static final Image imageBred = Image.asset('assets/imgs/air_jordan1_bred.png');
  static final Image imageJack = Image.asset('assets/imgs/air_jordan1_cactus_jack.png');
  static final Image imageOffwhite = Image.asset('assets/imgs/air_jordan1_offwhite.png');
  static final Image imageChicago = Image.asset('assets/imgs/air_jordan1_offwhite_chicago.png');
  static final Image imageUnc = Image.asset('assets/imgs/air_jordan1_offwhite_unc.png');
